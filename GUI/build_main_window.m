function build_main_window(environment, model, constants, calculation, settings)
    ...
    % Optimization
    handles.tabbutton(optimization_tab) = uicontrol(...
        'parent'  , MainWin,...
        'style'   , 'togglebutton',...
        'units'   , 'normalized',...
        'string'  , 'Optimization',...        
        ...
        'callback', @(varargin) callbacks('showtab', optimization_tab, varargin{:}));
    ...
    handles.tab(sequence_tab).panel = uipanel(...        
        ...
        constr_panel = uipanel(...
            ...
            uicontrol(...
                ...
                'style'   , 'text',...
                'horizontalalignment', 'left',...
                'position', [.01 .48 .22 .41],...
                'string'  , ['Min. dist. to ', model.CentralBody{1}, ':'])
        ...
        swingby_panel = handles.tab(sequence_tab).swingby_panel;
            ...
            for i = 1:4
                ...
                handles.tab(sequence_tab).GAM.jettison(i) = uicontrol(...
                    ...
                    'string'    , 'yes',...
                    'callback'  , @(varargin)...
                            modify_settings('change_single_setting', ['GAM.jettison(', num2str(i),')'], [], varargin{:}));
            end
    ...
    uicontrol(...
        ...
        'Units'     , 'normalized',...
        'horizontalalignment', 'left',...
        'Position'  , [0.0458715596330275 0.868326180257511 0.292267365661861 0.0472103004291845],...
        'String'    , 'Arrival type',...
        'Style'     , 'text');
    handles.tab(arrival_tab).ArrivalType = uicontrol(...
        ...
        'Units'     , 'normalized',...
        'Background', environment.colors.edit_bgcolor,...
        'Position'  , [0.0458715596330275 0.828326180257511 0.292267365661861 0.0472103004291845],...
    ...
    uicontrol(...
        ...
        'Units'     , 'normalized',...
        'Background', environment.colors.edit_bgcolor,...
        'Position'  , [0.097129750982962 0.759656652360515 0.205766710353866 0.0407725321888412],...
        'String'    , '0',...
        'enable'    , 'off',...
        'Style'     , 'edit');    
    uicontrol(...
        ...
        'Units'     , 'normalized',...
        'HorizontalAlignment','left',...
        'Position'  , [0.0458715596330275 0.761802575107296 0.0481520314547838 0.0300429184549356],...
        'String'    , 'Ha',...
        'Style'     , 'text',...
        'enable'    , 'off');
    % Value 2
    uicontrol(...
        ...
        'Units'     , 'normalized',...
        'Background', environment.colors.edit_bgcolor,...
        'Position'  , [0.097129750982962 0.703862660944206 0.205766710353866 0.0407725321888412],...
        'String'    , '0',...
        'enable'    , 'off',...
        'Style'     , 'edit');    
    uicontrol(...
        ...
        'Units'     , 'normalized',...
        'HorizontalAlignment','left',...
        'Position'  , [0.0458715596330275 0.710300429184549 0.0481520314547838 0.0300429184549356],...
        'String'    , 'Hp',...
        'enable'    , 'off',...
        'Style'     , 'text');
    % Value 3
    uicontrol(...
        ...
        'enable'    , 'off',...
        'Background', environment.colors.edit_bgcolor,...
        'Position'  , [0.097129750982962 0.645922746781116 0.205766710353866 0.0407725321888412],...
        'String'    , '0',...
        'Style'     , 'edit');
    uicontrol(...
        'Parent'    , handles.tab(arrival_tab).panel,...
        'Units'     , 'normalized',...
        'HorizontalAlignment','left',...
        'Position'  , [0.0458715596330275 0.645922746781116 0.0481520314547838 0.0300429184549356],...
        'String'    , 'i',...
        'enable'    , 'off',...
        'Style'     , 'text');
    ...
    handles.tab(arrival_tab).usr_costfun_arrival(1) = uicontrol(...
        'Parent'  , handles.tab(arrival_tab).panel,...
        'Units'   , 'normalized',...
        'Position', [0.03 0.534334763948498 0.294888597640891 0.0493562231759657],...
    ...
    handles.tab(arrival_tab).usr_costfun_arrival(3) = uicontrol(...
        'Parent'  , handles.tab(arrival_tab).panel,...
        'Units'   , 'normalized',...
        'Position', [0.40 0.54 0.11 0.05],...
        'String'  , 'Parameters...',...
        'enable'  , 'off',...
        'callback', @not_yet_done);
    
    % Arrival constraints
    arrival_constraint_panel = uipanel(...
        'title'     , 'Arrival constraints',...
        'Parent'    , handles.tab(arrival_tab).panel,...
        'Units'     , 'normalized',...
        'Position',[0.0249017038007864 0.0450643776824034 0.485 0.463519313304721]);        
        % C3 constraint
        uicontrol(...
            'Parent'  , arrival_constraint_panel,...
            'Units'   , 'normalized',...
        ...
        % Gravity loss    
        handles.tab(arrival_tab).ArrivalGravityLoss = uicontrol(...
            'Parent'    , arrival_constraint_panel,...
            'Units'     , 'normalized',...
            'Background', environment.colors.edit_bgcolor,...
            'Position'  , [0.50 0.635 0.30 0.1],...
            'Style'     , 'edit',...         
            'callback'  , @(varargin)...
                          modify_settings('change_single_setting', 'arrival.gravity_loss', [], varargin{:}));
        uicontrol(...
            'Parent'    , arrival_constraint_panel,...
            'Units'     , 'normalized',...
            'HorizontalAlignment','left',...
            'Position'  , [0.02 0.64 0.45 0.075],...
            'String'    , 'Insertion gravity loss:',...
            'Style'     , 'text');
        uicontrol(...
            'Parent'    , arrival_constraint_panel,...
            'Units'     , 'normalized',...
            'HorizontalAlignment','left',...
            'Position'  , [0.85 0.64 0.1 0.07],...
            'String'    , '%',...
            'Style'     , 'text');

        % Mass released before insertion    
        handles.tab(arrival_tab).InsertionMassRelease = uicontrol(...
            'Parent'    , arrival_constraint_panel,...
            'Units'     , 'normalized',...
            'Background', environment.colors.edit_bgcolor,...
            'Position'  , [0.50 0.49 0.30 0.1],...
            'Style'     , 'edit',...         
            'callback'  , @(varargin)...
                          modify_settings('change_single_setting', 'arrival.mass_released', [], varargin{:}));
        uicontrol(...
            'Parent'    , arrival_constraint_panel,...
            'Units'     , 'normalized',...
            'HorizontalAlignment','left',...
            'Position'  , [0.02 0.5 0.45 0.075],...
            'String'    , 'Mass released before insertion:',...
            'Style'     , 'text');
        uicontrol(...
            'Parent'    , arrival_constraint_panel,...
            'Units'     , 'normalized',...
            'HorizontalAlignment','left',...
            'Position'  , [0.85 0.5 0.1 0.07],...
            'String'    , 'kg',...
            'Style'     , 'text');
    ...
    handles.tab(arrival_tab).post_processing_panel = uipanel(...
        ...
        handles.tab(arrival_tab).post_processing.check = uicontrol(...
            ...
            'callback' , @(varargin) {callbacks('enable_postprocessing', varargin{:});
    ...
    % main panel
    handles.tab(optimization_tab).panel = uipanel(...        
        'position'  , [.01 .12 .985 .8],...        
        'bordertype', 'beveledout',...
        'visible'   , 'off');
    ...
    glob_panel = uipanel(...
        'Parent'  , handles.tab(optimization_tab).panel,...
        'Title'   , 'First-order (global optimization)',...                
        'Position', [0.020 0.523 0.598 0.456]);
        
        % optimizer
        handles.tab(optimization_tab).glob_opt_group = uibuttongroup(...
            'Parent'  , glob_panel,...
            'Title'   , 'Optimizer',...                        
            'Position', [0.029 0.0297 0.459 0.856],...
            'SelectionChangeFcn', @(varargin) modify_settings('change_single_setting',...
                'optimize.global.optimizer', 'handles.tab(optimization_tab).global_optimizer',...
                varargin{:})); 
            % GODLIKE
            handles.tab(optimization_tab).global_optimizer(1) = uicontrol(...
                'Parent'  , handles.tab(optimization_tab).glob_opt_group,...
                'Units'   , 'normalized',...
            ...
            handles.tab(optimization_tab).global_optimizer(2) = uicontrol(...
                'Parent'  , handles.tab(optimization_tab).glob_opt_group,...
                'Units'   , 'normalized',...
            ...
            handles.tab(optimization_tab).global_optimizer(3) = uicontrol(...
                'Parent'  , handles.tab(optimization_tab).glob_opt_group,...
                'Units'   ,'normalized',...
        ...
        low_approx_panel = uibuttongroup(...
            ...
            'handles.tab(optimization_tab).LowThrustApproximation', varargin{:})); 
            % Exposins
            handles.tab(optimization_tab).LowThrustApproximation(1) = uicontrol(...
            ...
            handles.tab(optimization_tab).LowThrustApproximation(2) = uicontrol(...
                'Parent'  , low_approx_panel,...
                'Units'   , 'normalized',...
    ...
    obj_panel = uipanel(...
        ...
        handles.tab(optimization_tab).MaxPayloadObjective = uicontrol(...
            'Parent'  , obj_panel,...
            'Units'   , 'normalized',...
        ...
        handles.tab(optimization_tab).MinTOFObjective = uicontrol(...
            'Parent'  , obj_panel,...
            'Units'   , 'normalized',...
        ...
        handles.tab(optimization_tab).OtherObjectives.check = uicontrol(...
            'Parent'  , obj_panel,...
            'Units'   , 'normalized',...
        ...
        handles.tab(optimization_tab).OtherObjectives.button = uicontrol(...
            'Parent'  , obj_panel,...
            'Units'   , 'normalized',...
    ...
    loc_panel = uipanel(...
        ...
        loc_opt_group = uibuttongroup(...
            ...
            'SelectionChangeFcn', @(varargin)...
                ...
                'handles.tab(optimization_tab).local_optimizer', varargin{:}));
            % FMINCON (if available)
            handles.tab(optimization_tab).local_optimizer(1) = uicontrol(...
            ...
            handles.tab(optimization_tab).local_optimizer(2) = uicontrol(...
                'Parent'  , loc_opt_group,...
                'Units'   , 'normalized',...
            ...
            handles.tab(optimization_tab).local_optimizer(3) = uicontrol(...
                'Parent'  , loc_opt_group,...
                'Units'   , 'normalized',...
        ...
        int_panel = uibuttongroup(...
            ...
            'SelectionChangeFcn', @(varargin)...
                    ...
                    'handles.tab(optimization_tab).integrator', varargin{:}));
            % ODE4(5)
            handles.tab(optimization_tab).integrator(1) = uicontrol(...
                'Parent'  , int_panel,...
                'Units'   , 'normalized',...
                ...
                'Style'   , 'radiobutton');    
            % RKN8(6)
            handles.tab(optimization_tab).integrator(2) = uicontrol(...
                'Parent'  , int_panel,...
                'Units'   , 'normalized',...
                ...
                'Style'   , 'radiobutton');   
            % RKN12(10)
            handles.tab(optimization_tab).integrator(3) = uicontrol(...
                'Parent'  , int_panel,...
                'Units'   , 'normalized',...
        ...
        loc_method_group = uibuttongroup(...
            ...
            'SelectionChangeFcn', @(varargin)...
                    ...
                    'handles.tab(optimization_tab).low_thrust_optimization_method', varargin{:}));
                % Sims & Flanagan's method
                handles.tab(optimization_tab).low_thrust_optimization_method(1) = uicontrol(...
                ...
                % Collocation
                handles.tab(optimization_tab).low_thrust_optimization_method(2) = uicontrol(...
                    'Parent'  , loc_method_group,...
                    'Units'   , 'normalized',...
    ...
    eph_panel = uibuttongroup(...
        ...
        'SelectionChangeFcn', @(varargin)...
                    ...
                    'handles.tab(optimization_tab).Ephemerides', varargin{:}));
         %JPL / HORIZONS system             
         handles.tab(optimization_tab).Ephemerides(1) = uicontrol(...
            'Parent'  , eph_panel,...
            'Units'   , 'normalized',...
            ...
            'Style'   , 'radiobutton'); 
        % Kepler (direct)        
        handles.tab(optimization_tab).Ephemerides(2) = uicontrol(...
            'Parent'  , eph_panel,...
            'Units'   , 'normalized',...
        ...
        handles.tab(optimization_tab).Ephemerides(3) = uicontrol(...
            'Parent'  , eph_panel,...
            'Units'   , 'normalized',...
