function varargout = find_nearby_MPs(varargin) %#ok<VANUS>
    ...
    function GUI_interaction(value)
        ...
        threshold_group = uibuttongroup(...
            ...
            'SelectionChangeFcn', @(varargin){...
                callbacks('find_nearby_MPs_threshold',...
                          varargin{:});
                modify_settings('change_single_setting', ...
                                'postprocessing.threshold.check',...
            ...
            handles.tab(arrival_tab).post_processing.additional_controls.constant_threshold.value = uicontrol(...
                ...
                'callback', @(varargin) ...
                    modify_settings('change_single_setting',...
                                    'postprocessing.constant_threshold.distance',...
                                    [],...
                                    varargin{:})...
            );
            ...
            handles.tab(arrival_tab).post_processing.additional_controls.variable_threshold.value(1) = uicontrol(...
                ...
                'callback', @(varargin) ...
                    modify_settings('change_single_setting',...
                                    'postprocessing.variable_threshold.distance(1)',...
                                    [],...
                                    varargin{:})...
            );
            ...
            handles.tab(arrival_tab).post_processing.additional_controls.variable_threshold.value(2) = uicontrol(...
                ...
                'callback', @(varargin) ...
                    modify_settings('change_single_setting',...
                                    'postprocessing.variable_threshold.distance(2)',...
                                    [],...
                                    varargin{:})...
            );
            ...
            handles.tab(arrival_tab).post_processing.additional_controls.variable_threshold.value(3) = uicontrol(...
                ...
                'callback', @(varargin) ...
                    modify_settings('change_single_setting',...
                                    'postprocessing.variable_threshold.distance(3)',...
                                    [],...
                                    varargin{:})...
            );
            ...
            uicontrol(...
                ...
                'callback', @(varargin)...
                    modify_settings('change_single_setting', ...
                                    'postprocessing.optimize_distance.check',...
                                    [],...
                                    varargin{:})...
            );
